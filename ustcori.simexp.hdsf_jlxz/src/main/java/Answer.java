        ...
        try {
            for (int num = 0; num < ParaList.size(); num++) {
                switch (ParaList.get(num)._Formula) {
                    ...
                    case "JieDian1": {
                        ParaList.set(num, Function.JieDian1(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian2": {
                        ParaList.set(num, Function.JieDian2(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian3": {
                        ParaList.set(num, Function.JieDian3(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian4": {
                        ParaList.set(num, Function.JieDian4(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian6": {
                        ParaList.set(num, Function.JieDian6(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian7": {
                        ParaList.set(num, Function.JieDian7(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian8": {
                        ParaList.set(num, Function.JieDian8(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian9": {
                        ParaList.set(num, Function.JieDian9(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian10": {
                        ParaList.set(num, Function.JieDian10(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian11": {
                        ParaList.set(num, Function.JieDian11(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian13": {
                        ParaList.set(num, Function.JieDian13(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "JieDian14": {
                        ParaList.set(num, Function.JieDian14(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    default:
                        break;
