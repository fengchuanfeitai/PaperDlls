        ...
        try {
            for (int num = 0; num < ParaList.size(); num++) {
                ...
                switch (ParaList.get(num)._Formula) {
                    case "BLDT_List1": {
                        ParaList.set(num, Function.BLDT_List1(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "BLDT_List1_2": {
                        ParaList.set(num, Function.BLDT_List1_2(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "BLDT_DDS": {
                        ParaList.set(num, Function.BLDT_DDS(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "BLDT_List3": {
                        ParaList.set(num, Function.BLDT_List3(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "BLDT_SRSL": {
                        ParaList.set(num, Function.BLDT_SRSL(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "BLDT_DRXS": {
                        ParaList.set(num, Function.BLDT_DRXS(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
