        ...
        try {
            for (int num = 0; num < ParaList.size(); num++) {
                ...
                switch (ParaList.get(num)._Formula)
                {
                    ...
                    case "DianQiao1":
                    {
                        ParaList.set(num,Function.DianQiao1(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao2":
                    {
                        ParaList.set(num,Function.DianQiao2(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao3":
                    {
                        ParaList.set(num,Function.DianQiao3(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao4":
                    {
                        ParaList.set(num,Function.DianQiao4(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao5":
                    {
                        ParaList.set(num,Function.DianQiao5(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao6":
                    {
                        ParaList.set(num,Function.DianQiao6(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao7":
                    {
                        ParaList.set(num,Function.DianQiao7(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao8":
                    {
                        ParaList.set(num,Function.DianQiao8(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    case "DianQiao9":
                    {
                        ParaList.set(num,Function.DianQiao9(ParaList.get(num), DStoPP(ParaList.get(num)._DataSourse)));
                        break;
                    }
                    default:
                        break;
